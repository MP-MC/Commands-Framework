package tk.empee.commandsFramework;
...
import tk.empee.commandsFramework.command.Command;
import tk.empee.commandsFramework.helpers.CommandMap;
import tk.empee.commandsFramework.parsers.ParserManager;
import tk.empee.commandsFramework.parsers.types.*;
import tk.empee.commandsFramework.parsers.types.annotations.*;
import tk.empee.commandsFramework.parsers.types.annotations.greedy.MsgParam;
import tk.empee.commandsFramework.parsers.types.greedy.MsgParser;
import tk.empee.commandsFramework.services.CompletionService;
