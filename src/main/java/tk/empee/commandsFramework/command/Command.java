...
import tk.empee.commandsFramework.CommandManager;
import tk.empee.commandsFramework.command.annotations.CommandRoot;
import tk.empee.commandsFramework.helpers.PluginCommand;
import tk.empee.commandsFramework.parsers.ParameterParser;
import tk.empee.commandsFramework.parsers.types.IntegerParser;
...
public abstract class Command implements CommandExecutor, TabCompleter {
    ...
    public final org.bukkit.command.PluginCommand build(CommandManager commandManager) {
        ...
        pluginCommand = PluginCommand.createInstance(rootMethod.getAnnotation(CommandRoot.class), rootMethod.getAnnotation(tk.empee.commandsFramework.command.annotations.CommandNode.class), commandManager.getPlugin());
